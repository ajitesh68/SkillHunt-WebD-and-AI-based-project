  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <li onClick={() => handleTabChange("home")} style={{ cursor: "pointer" }}>Home</li>
          <li onClick={() => handleTabChange("findSkillHunt")} style={{ cursor: "pointer" }}>Find a SkillHunt</li>
          <li onClick={() => handleTabChange("createTeam")} style={{ cursor: "pointer" }}>Create a Team</li>
          <li onClick={() => handleTabChange("findMembers")} style={{ cursor: "pointer" }}>Find Members</li>
        </ul>
      </div>
